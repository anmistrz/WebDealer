...
public partial class DBRndDealerContext : DbContext
{
    public DBRndDealerContext(DbContextOptions<DBRndDealerContext> options)
        : base(options)
    {
    }

    public DBRndDealerContext()
    {
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.AgreementId).HasName("PK__Agreemen__0A309D23111F3019");

            entity.ToTable("Agreement");

            entity.HasIndex(e => e.LoiId, "UQ__Agreemen__412C029B3496210E").IsUnique();
            ...
            entity.HasOne(d => d.Customer).WithMany(p => p.Agreements)
                ...
                .HasConstraintName("FK__Agreement__Custo__00200768");

            entity.HasOne(d => d.DealerCar).WithMany(p => p.Agreements)
                .HasForeignKey(d => d.DealerCarId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__Agreement__Deale__02084FDA");

            entity.HasOne(d => d.Loi).WithOne(p => p.Agreement)
                .HasForeignKey<Agreement>(d => d.LoiId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__Agreement__LoiID__02FC7413");

            entity.HasOne(d => d.SalesPerson).WithMany(p => p.Agreements)
                .HasForeignKey(d => d.SalesPersonId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__Agreement__Sales__01142BA1");
        });

        modelBuilder.Entity<Car>(entity =>
        {
            entity.HasKey(e => e.CarId).HasName("PK__Car__68A0340E8A3C8C6A");
        ...
        {
            entity.HasKey(e => e.ConsultHistoryId).HasName("PK__ConsultH__C5DB29E8C57071CA");
        ...
        {
            entity.HasKey(e => e.CreditAppId).HasName("PK__CreditAp__5F45706CF59056E4");

            entity.ToTable("CreditApplication");

            entity.HasIndex(e => e.AgreementId, "UQ__CreditAp__0A309D22BF3C80B0").IsUnique();
            ...
            entity.HasOne(d => d.Agreement).WithOne(p => p.CreditApplication)
                ...
                .HasConstraintName("FK__CreditApp__Agree__0F624AF8");
        });

        modelBuilder.Entity<Customer>(entity =>
        {
            entity.HasKey(e => e.CustomerId).HasName("PK__Customer__A4AE64B89B5B365C");

            entity.ToTable("Customer");

            entity.HasIndex(e => e.Email, "UQ__Customer__A9D105341E958495").IsUnique();
        ...
        {
            entity.HasKey(e => e.RatingId).HasName("PK__Customer__FCCDF85C9E3B84CA");
        ...
        {
            entity.HasKey(e => e.DealerId).HasName("PK__Dealer__CA2F8E92FA5C6135");
        ...
        {
            entity.HasKey(e => e.DealerCarId).HasName("PK__DealerCa__7DD0B566B1FC674F");
        ...
        {
            entity.HasKey(e => e.DealerCarUnitId).HasName("PK__DealerCa__28B4C5F2E991B3A9");
            ...
            entity.HasIndex(e => e.Vin, "UQ__DealerCa__C5DF234C4F922199").IsUnique();
        ...
        {
            entity.HasKey(e => e.DocumentId).HasName("PK__Document__1ABEEF6F4DB34A57");
            ...
            entity.HasOne(d => d.CreditApp).WithMany(p => p.DocumentCreditApplications)
                ...
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__DocumentC__Credi__123EB7A3");
        });

        modelBuilder.Entity<LetterOfIntent>(entity =>
        {
            entity.HasKey(e => e.LoiId).HasName("PK__LetterOf__412C029A9B8AA0EC");
        ...
        {
            entity.HasKey(e => new { e.LoiId, e.DealerCarId }).HasName("PK__LoiCarFr__36F109CC4B4C304F");
            ...
            entity.HasOne(d => d.DealerCar).WithMany(p => p.LoiCarFromDealers)
                .HasForeignKey(d => d.DealerCarId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__LoiCarFro__Deale__7A672E12");

            entity.HasOne(d => d.Loi).WithMany(p => p.LoiCarFromDealers)
                .HasForeignKey(d => d.LoiId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__LoiCarFro__LoiID__797309D9");
        });

        modelBuilder.Entity<Notification>(entity =>
        {
            entity.HasKey(e => e.NotificationId).HasName("PK__Notifica__20CF2E32720B50E4");
        ...
        {
            entity.HasKey(e => e.PaymentHistoryId).HasName("PK__PaymentH__F3B93391490E0639");
            ...
            entity.HasOne(d => d.Purchase).WithMany(p => p.PaymentHistories)
                ...
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__PaymentHi__Purch__151B244E");
        });

        modelBuilder.Entity<Purchase>(entity =>
        {
            entity.HasKey(e => e.PurchaseId).HasName("PK__Purchase__6B0A6BDEA04A15AA");

            entity.ToTable("Purchase");

            entity.HasIndex(e => e.AgreementId, "UQ__Purchase__0A309D22919CAE1D").IsUnique();
            ...
            entity.HasOne(d => d.Agreement).WithOne(p => p.Purchase)
                ...
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__Purchase__Agreem__09A971A2");

            entity.HasOne(d => d.Customer).WithMany(p => p.Purchases)
                .HasForeignKey(d => d.CustomerId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__Purchase__Custom__08B54D69");
        });

        modelBuilder.Entity<SalesActivityLog>(entity =>
        {
            entity.HasKey(e => e.ActivityLogId).HasName("PK__SalesAct__19A9B78F3F66136E");
        ...
        {
            entity.HasKey(e => e.SalesPersonId).HasName("PK__SalesPer__7A591C1870A3F286");
        ...
        {
            entity.HasKey(e => e.PerformanceId).HasName("PK__SalesPer__F9606DE107286340");
        ...
        {
            entity.HasKey(e => e.TestDriveId).HasName("PK__TestDriv__BF98EF72E7686829");
            ...
            entity.HasOne(d => d.Car).WithMany(p => p.TestDrives)
                .HasForeignKey(d => d.CarId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__TestDrive__CarID__5812160E");
            ...
            entity.HasOne(d => d.DealerCarUnit).WithMany(p => p.TestDrives)
                ...
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__TestDrive__Deale__1F98B2C1");
        ...
        {
            entity.HasKey(e => e.ClaimId).HasName("PK__Warranty__EF2E13BB73DE51BB");
            ...
            entity.HasOne(d => d.Customer).WithMany(p => p.WarrantyClaims)
                .HasForeignKey(d => d.CustomerId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__WarrantyC__Custo__1EA48E88");

            entity.HasOne(d => d.Warranty).WithMany(p => p.WarrantyClaims)
                .HasForeignKey(d => d.WarrantyId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__WarrantyC__Warra__1DB06A4F");
        });

        modelBuilder.Entity<WarrantyRegistration>(entity =>
        {
            entity.HasKey(e => e.WarrantyId).HasName("PK__Warranty__2ED318F3255D14D5");

            entity.ToTable("WarrantyRegistration");

            entity.HasIndex(e => e.DealerCarId, "UQ__Warranty__7DD0B56781BCCA90").IsUnique();
            ...
            entity.HasOne(d => d.DealerCar).WithOne(p => p.WarrantyRegistration)
                ...
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__WarrantyR__Deale__18EBB532");
        });
